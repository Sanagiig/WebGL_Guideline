function main() {
    ...
    function initVetexBuffers(gl) {
        ...
        let a_Textures = gl.getAttribLocation(gl.program, "a_Textures");
        ...
        gl.vertexAttribPointer(a_Position, 2, gl.FLOAT, false, arrElementByte * 4, 0);
        // 连接 a_Position 变量 & 分配给它的缓冲区对象
        gl.enableVertexAttribArray(a_Position);
        gl.vertexAttribPointer(a_Textures, 2, gl.FLOAT, false, arrElementByte * 4, arrElementByte * 2);
