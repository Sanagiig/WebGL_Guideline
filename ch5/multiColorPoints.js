...
function main() {
    ...
    function initVetexBuffers(gl) {
        ...
        gl.vertexAttribPointer(a_Position, 2, gl.FLOAT, false, arrElementByte * 6, 0);
        // 连接 a_Position 变量 & 分配给它的缓冲区对象
        gl.enableVertexAttribArray(a_Position);
        gl.vertexAttribPointer(a_PointSize, 1, gl.FLOAT, false, arrElementByte * 6, arrElementByte * 2);
        gl.enableVertexAttribArray(a_PointSize);
        gl.vertexAttribPointer(a_Color, 3, gl.FLOAT, false, arrElementByte * 6, arrElementByte * 3);
